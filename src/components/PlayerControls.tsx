  ...
  const handlePlayPause = async () => {
    try {
      if (playerState.is_playing) {
        ...
        console.log(
          `[PlayerControls] Playing loaded track from active queue: ${currentTrack.file_path}`,
        );
        await playerApi.playFile(
          currentTrack.file_path,
          currentTrack.normalization_gain_db,
        );
      }
    } catch (error) {
          ...
          >
            <Box
              ...
              sx={{
                ...
                position: "relative",
                width: "100%",
                maskImage: titleOverflows
                  ? "linear-gradient(to right, black 85%, transparent)"
                  : "none",
                WebkitMaskImage: titleOverflows
                  ? "linear-gradient(to right, black 85%, transparent)"
                  : "none",
              }}
            >
            ...
            >
              ...
              <Box
                ...
                sx={{
                  ...
                  position: "relative",
                  width: 0,
                  maskImage: artistOverflows
                    ? "linear-gradient(to right, black 85%, transparent)"
                    : "none",
                  WebkitMaskImage: artistOverflows
                    ? "linear-gradient(to right, black 85%, transparent)"
                    : "none",
                }}
              >
            ...
            >
              ...
              <Box
                ...
                sx={{
                  ...
                  position: "relative",
                  width: 0,
                  maskImage: albumOverflows
                    ? "linear-gradient(to right, black 85%, transparent)"
                    : "none",
                  WebkitMaskImage: albumOverflows
                    ? "linear-gradient(to right, black 85%, transparent)"
                    : "none",
                }}
              >
          ...
          >
            {isNarrow && (
              <Box
                ...
                sx={{
                  ...
                  whiteSpace: "nowrap",
                  position: "relative",
                  maskImage: mobileTitleOverflows
                    ? "linear-gradient(to right, black 85%, transparent)"
                    : "none",
                  WebkitMaskImage: mobileTitleOverflows
                    ? "linear-gradient(to right, black 85%, transparent)"
                    : "none",
                }}
              >
                <Typography
                  ...
                  sx={{
                    color: "text.primary",
                    display: "inline-block",
                    paddingLeft: isNarrow ? "12px" : "0",
                    paddingRight: mobileTitleOverflows ? "40px" : "0",
                    animation: mobileTitleOverflows
                      ? "scroll-text 10s linear infinite"
                      : "none",
                    "@keyframes scroll-text": {
                      "0%": { transform: "translateX(0%)" },
            ...
            {!isNarrow && (
              ...
              >
                ...
                <IconButton
                  onClick={() => void cycleFloatingLyricsMode()}
                  size="small"
                  title={`Floating lyrics: ${floatingLyricsMode}`}
                  sx={{ color: floatingLyricsMode === "off" ? "text.primary" : "primary.main" }}
                >
