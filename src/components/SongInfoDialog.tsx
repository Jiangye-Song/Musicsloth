    ...
    >
      ...
      <DialogContent>
        ...
        >
          ...
          <Typography
            variant="body2"
            onContextMenu={(e) => copyToClipboard(track.title, e)}
            sx={{ userSelect: "text" }}
          >
            {track.title}
          </Typography>
          ...
          <Box
            ...
            onContextMenu={(e) => copyToClipboard(track.artist, e)}
          >
          ...
          <Typography
            variant="body2"
            onContextMenu={(e) => copyToClipboard(track.album_artist, e)}
            sx={{ userSelect: "text" }}
          >
            {track.album_artist || "—"}
          </Typography>
          ...
          <Typography
            ...
            onContextMenu={(e) => copyToClipboard(track.album, e)}
            sx={{
              cursor:
          ...
          <Typography
            variant="body2"
            onContextMenu={(e) => copyToClipboard(track.year?.toString(), e)}
            sx={{ userSelect: "text" }}
          >
            {track.year || "—"}
          </Typography>
          ...
          <Box
            sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}
            onContextMenu={(e) => copyToClipboard(track.genre, e)}
          >
          ...
          <Typography
            variant="body2"
            onContextMenu={(e) => copyToClipboard(track.file_path, e)}
            sx={{
              userSelect: "text",
              wordBreak: "break-all",
              fontSize: "0.75rem",
